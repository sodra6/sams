                ...
                <BT.Row>
                  <BT.Col md={12}>
                    <div className="border-secondary border-bottom mt-4 mb-3">
                      <BT.Row>
                        <BT.Col lg="3" className="me-auto">
                            <h5 className="card-subtitle pt-3">2022년 교체사업 죄적 투가계획(안)</h5>
                        </BT.Col>
                        <BT.Col lg="9" md="auto">
                            <div className="d-grid gap-3 d-md-flex justify-content-md-end">
                                <BT.Col sm="3">
                                    <BT.Form.Group as={BT.Row} controlId="biz-price" className="align-items-center">
                                        <BT.Form.Label column sm="7" className="text-center">
                                            22년 최근년도 사업비(원)
                                        </BT.Form.Label>
                                        <BT.Col sm="5">
                                            <BT.Form.Control size="sm" className="text-end" disabled />
                                        </BT.Col>
                                    </BT.Form.Group>
                                </BT.Col>
                                <BT.Col sm="3">
