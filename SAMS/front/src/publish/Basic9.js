                  ...
                  <BT.Row>
                    ...
                    <BT.Col md="auto">
                      <BT.Breadcrumb>
                        ...
                        <BT.Breadcrumb.Item href="#">기본정보 관리</BT.Breadcrumb.Item>
                        <BT.Breadcrumb.Item active>코드관리</BT.Breadcrumb.Item>
                      </BT.Breadcrumb>
                    </BT.Col>
                  </BT.Row>
                </div>
                                    ...
                                    <BT.Row>
                                            ...
                                            <div className="border-secondary border-bottom mt-2 mb-3">
                                                <BT.Row>
                                                    <BT.Col lg="4" className="me-auto">
                                                        <h5 className="card-subtitle pt-3">공통코드 목록</h5>
                                                    </BT.Col>
                                                    <BT.Col lg="8" md="auto">
                                        ...
                                        <BT.Col md={7}>
                                            <div className="border-secondary border-bottom mt-2 mb-3">
                                                <BT.Row>
                                                    <BT.Col lg="4" className="me-auto">
                                                        <h5 className="card-subtitle pt-3">공통코드 상세목록</h5>
                                                    </BT.Col>
                                                    <BT.Col lg="8" md="auto">
                                                        <div className="d-grid gap-1 d-md-flex justify-content-md-end">                                                            
                                                            <BT.Col sm="4" md="auto">
