/**
 * AUIGridReact.js for React.js v1.2.20230125
 * Based on AUIGrid v3.0.12.1
...
// 프로젝트 경로에 맞게 바꾸세요
import "../AUIGrid-Core/AUIGrid";
import "../AUIGrid-Core/AUIGridLicense";
import "../AUIGrid-Core/AUIGrid_style.css";
...
class AUIGrid extends React.Component {
  ...
  componentDidMount() {
    ...
    //브라우저에 세로 스크롤 생길시 그리드 세로스크롤이 옆으로 빠져나오는 현상이 발생하여 추가함
